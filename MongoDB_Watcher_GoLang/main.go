...
type DbEvent struct {
	...
	FullDocument  result      `bson:"fullDocument"`
	ID            _idResult   `bson:"_id"`
}

type _idResult struct {
...
func listenToDBChangeStream(
	...
	for stream.Next(routineCtx) {
		...
		fmt.Printf("DbEvent is %v", DbEvent)
...
func main() {
	...
	stream, err := collection.Watch(context.TODO(), mongo.Pipeline{}, options.ChangeStream().SetResumeAfter(
		bson.M{
			"_data": "8264E5E9F50000088D2B022C0100296E5A1004834399BE56FE4E199E701E0C2C74ADBA46645F6964006464E5E9F53EB2EC467DCB6B680004",
		},
	))
	if err != nil {
		panic(err)
